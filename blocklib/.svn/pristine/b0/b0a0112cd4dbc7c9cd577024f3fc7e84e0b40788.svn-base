  ...
  methods
    ...
    function val = get.CoeffsTarget(this)
        if (this.Variant == FirUpVariantEnum.WithFir)
            val = FirUpTranslation(this.CoeffsRaw, this.UpFactor, this.Variant, this.VariantObj.Fir.Variant);
        else
            val = FirUpTranslation(this.CoeffsRaw, this.UpFactor, this.Variant);
        end
    end
    %----------------------------------------------------------------------
