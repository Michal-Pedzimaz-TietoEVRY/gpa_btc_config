classdef RifftWolaHexagonVariantConfig < BtcVariant
% RifftWolaHexagonVariantConfig Build-time configuration class for the RifftWolaHexagon variant
% Usage:
...
%   Copyright 2023 Bose Corporation
  ...
  methods
    %----------------------------------------------------------------------
    function this = RifftWolaHexagonVariantConfig(constructingParentObj)
    ...
    function VariantValidate(this)
        ...
        if (this.Parent.FftSize ~= 256 && this.Parent.FftSize ~= 128)
            error("This variant of Rifft does not support FftSize of %d", this.Parent.FftSize);
        end
    end
    %----------------------------------------------------------------------
