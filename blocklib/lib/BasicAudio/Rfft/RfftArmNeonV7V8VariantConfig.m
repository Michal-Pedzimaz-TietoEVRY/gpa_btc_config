classdef RfftArmNeonV7V8VariantConfig < BtcVariant
% RfftArmNeonV7V8VariantConfig Build-time configuration class for the RfftArmNeonV7V8 variant
% Usage:
...
%   Copyright 2023 Bose Corporation
  ...
  methods
    %----------------------------------------------------------------------
    function this = RfftArmNeonV7V8VariantConfig(constructingParentObj)
