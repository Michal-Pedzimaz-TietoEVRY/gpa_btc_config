classdef FirGenericVariantConfig < BtcVariant
% FirGenericVariantConfig Build-time configuration class for the FirGeneric variant
% Usage:
...
%   Copyright 2023 Bose Corporation
  ...
  methods
    %----------------------------------------------------------------------
    function this = FirGenericVariantConfig(constructingParentObj)
