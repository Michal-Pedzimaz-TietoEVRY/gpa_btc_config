...
#ifndef DEFINED_TYPEDEF_FOR_struct_plCvCqbh0Ti6RXywUTNetG_
#define DEFINED_TYPEDEF_FOR_struct_plCvCqbh0Ti6RXywUTNetG_
...
typedef struct
{
    ...
    real_T groupNumber;
    real_T partitionNumber;
}
struct_plCvCqbh0Ti6RXywUTNetG;
...
/* Custom Type definition for MATLAB Function: '<S1523>/tone control' */
