...
#include "Model_Target_Partitions.h"   // from PartitionSFunc.tlc
...
extern void Model_Target_rgainyprocess(const uint8_T rtu_rampToChanMap[3], const
...
extern void Model_Target_MATLABFunction(const real32_T rtu_x[129], real32_T
    rtu_pole, real32_T rtu_gain, B_MATLABFunction_Model_Target_T *localB,
...
extern void Model_Target_MATLABFunction_m(const int32_T rtu_tuneTopMap[18],
    const int32_T rtu_rtcMap[18], B_MATLABFunction_Model_Target_h_T *localB);
extern void Model_Target_MATLABFunction_m_Init
    (DW_MATLABFunction_Model_Target_i_T *localDW);
extern void Model_Target_MATLABFunction_j(real32_T rtu_tgain, real32_T
    rtu_ramp_db_per_samp, real_T rtu_minGain, real32_T *rty_gval,
    DW_MATLABFunction_Model_Target_i_T *localDW);
extern void Model_Target_InnerLink_g_Init(DW_InnerLink_Model_Target_o_T *localDW);
extern void Model_Target_InnerLink_n(real32_T rtu_rmsInput, real32_T
    rtu_peakInput, real32_T rtu_slowDecayDbPerSample, real32_T rtu_holdMarginDb,
    real32_T rtu_holdTimeSamples, real32_T rtu_fastDecayDbPerSample, real32_T
    rtu_minVolumeDb, real32_T rtu_maxVolumeDb, real_T rtu_AnnTrigger, real32_T
    rtu_mode1, DW_InnerLink_Model_Target_o_T *localDW);
extern void Model_Target_MATLABFunction_m0(uint32_T rtu_vncEnableIn,
...
extern void Model_Target_SetDsm_i1(uint32_T rtp_Value);
extern void Model_Target_rgainyrampercontrol_n(real32_T rtu_target_gains_linear,
    real_T rtu_db_per_sec, real_T rtu_ramp_times_ms, real32_T
    rtu_sample_rate_in_hertz, real32_T rtu_frame_size);
extern void Model_Target_rgainyprocess_l(const uint8_T rtu_rampToChanMap[2],
    const real32_T rtu_audioIn[32], B_rgainyprocess_Model_Target_b_T *localB);
extern void Model_Target_SetDsm_mp(uint32_T rtp_Value);
extern void Model_Target_rgainyrampercontrol_d(real32_T rtu_target_gains_linear,
    real_T rtu_db_per_sec, real_T rtu_ramp_times_ms, real32_T
    rtu_sample_rate_in_hertz, real32_T rtu_frame_size);
extern void Model_Target_rgainyprocess_j(const uint8_T rtu_rampToChanMap[2],
    const real32_T rtu_audioIn[32], B_rgainyprocess_Model_Target_e_T *localB);
extern void Model_Target_SetDsm_b(uint32_T rtp_Value);
extern void Model_Target_rgainyrampercontrol_o(real32_T rtu_target_gains_linear,
    real_T rtu_db_per_sec, real_T rtu_ramp_times_ms, real32_T
    rtu_sample_rate_in_hertz, real32_T rtu_frame_size);
extern void Model_Target_rgainyprocess_n(const uint8_T rtu_rampToChanMap[2],
    const real32_T rtu_audioIn[32], B_rgainyprocess_Model_Target_k_T *localB);
extern void Model_Target_SetDsm_bb(uint32_T rtp_Value);
extern void Model_Target_rgainyrampercontrol_a(real32_T rtu_target_gains_linear,
    real_T rtu_db_per_sec, real_T rtu_ramp_times_ms, real32_T
    rtu_sample_rate_in_hertz, real32_T rtu_frame_size);
extern void Model_Target_rgainyprocess_h(const uint8_T rtu_rampToChanMap[2],
    const real32_T rtu_audioIn[32], B_rgainyprocess_Model_Target_m_T *localB);
extern void Model_Target_AlignmentDelay(void);
extern void InitTrigger_Model_141_3728_59_156(void);
extern void InitTrigger_Model_141_3728_59_192(void);
extern void InitTrigger_Model_141_3745_59_156(void);
extern void InitTrigger_Model_141_3745_59_192(void);
...
extern void InitTrigger_Model_141_472_255_172_156(void);
extern void InitTrigger_Model_141_472_255_172_192(void);
extern void InitTrigger_Model_141_473_12_172_156(void);
extern void InitTrigger_Model_141_473_12_172_192(void);
extern void InitTrigger_Model_141_595_232_99(void);
extern void InitTrigger_Model_141_595_232_224(void);
extern void InitTrigger_Model_141_595_238_172_156(void);
extern void InitTrigger_Model_141_595_238_172_192(void);
...
extern void HandleReqPreAmpMidrangeSet(void);
...
extern void Model_Target_InputSelect_Init(void);
...
extern void InitTrigger_Model_117_516_1977_115_100(void);
extern void InitTrigger_Model_117_516_1849_50_172_156(void);
extern void InitTrigger_Model_117_516_1849_50_172_192(void);
extern void InitTrigger_Model_117_516_1847_50_172_156(void);
extern void InitTrigger_Model_117_516_1847_50_172_192(void);
extern void InitTrigger_Model_117_517_563_115_100(void);
extern void InitTrigger_Model_117_517_515_50_172_156(void);
extern void InitTrigger_Model_117_517_515_50_172_192(void);
extern void InitTrigger_Model_117_517_516_50_172_156(void);
extern void InitTrigger_Model_117_517_516_50_172_192(void);
extern void InitTrigger_Model_120_422_50_172_156(void);
extern void InitTrigger_Model_120_422_50_172_192(void);
extern void HandleReqPreAmpVolumeCfgSet(void);
extern void HandleReqPreAmpBalance_CfgSet(void);
extern void InitTrigger_Model_141_246_141_172_156(void);
extern void InitTrigger_Model_141_246_141_172_192(void);
extern void InitTrigger_Model_141_246_148_172_156(void);
extern void InitTrigger_Model_141_246_148_172_192(void);
extern void InitTrigger_Model_141_248_38_65(void);
extern void InitTrigger_Model_141_248_38_84(void);
extern void Model_Target_Medusa5H1Part1_Init(void);
extern void Model_Target_Medusa5H1Part1(void);
extern void InitTrigger_Model_141_2210_65(void);
extern void InitTrigger_Model_141_2215_100(void);
extern void InitTrigger_Model_141_2876_65(void);
extern void InitTrigger_Model_141_2881_100(void);
extern void InitTrigger_Model_141_2934_156(void);
extern void InitTrigger_Model_141_2934_192(void);
extern void InitTrigger_Model_141_3073_50_172_156(void);
extern void InitTrigger_Model_141_3073_50_172_192(void);
...
extern void InitTrigger_Model_416_65(void);
extern void InitTrigger_Model_416_84(void);
...
extern void InitTrigger_Model_771_172_156(void);
extern void InitTrigger_Model_771_172_192(void);
extern void InitTrigger_Model_889_172_156(void);
extern void InitTrigger_Model_889_172_192(void);
extern void InitTrigger_Model_1040_172_156(void);
extern void InitTrigger_Model_1040_172_192(void);
extern void InitTrigger_Model_1078_172_156(void);
extern void InitTrigger_Model_1078_172_192(void);
extern void InitTrigger_Model_1221_143_65(void);
extern void InitTrigger_Model_1221_143_84(void);
extern void InitTrigger_Model_1259_172_156(void);
extern void InitTrigger_Model_1259_172_192(void);
