...
#ifndef RTW_HEADER_Model_Target_SCH_API_h_
#define RTW_HEADER_Model_Target_SCH_API_h_
#include "ASDID.h"

// ------------------------------------------------------------
// SCH MESSAGE IDS (Static Version Token)
// ------------------------------------------------------------
#define SCHID_GetTalariaVersion        (0x10f70000U)             // REQ, RSP
#define SCHID_GetTopCompatHash         (0x10f70001U)             // REQ, RSP
#define SCHID_GetTspCompatHash         (0x10f70002U)             // REQ, RSP
#define SCHID_GetRtcCompatHash         (0x10f70003U)             // REQ, RSP
...
typedef GetCompatHash_REQ_T GetTopCompatHash1_REQ_T;
...
typedef GetCompatHash_REQ_T GetTspCompatHash1_REQ_T;
...
typedef GetCompatHash_REQ_T GetRtcCompatHash1_REQ_T;
...
/// used by the GetTopCompatHash1 RTC mechanism. For a more general
/// description of how this message works, see @ref GetTopCompatHash1.
typedef GetCompatHash_RSP_T GetTopCompatHash1_RSP_T;
...
/// used by the GetTspCompatHash1 RTC mechanism. For a more general
/// description of how this message works, see @ref GetTspCompatHash1.
typedef GetCompatHash_RSP_T GetTspCompatHash1_RSP_T;
...
/// used by the GetRtcCompatHash1 RTC mechanism. For a more general
/// description of how this message works, see @ref GetRtcCompatHash1.
typedef GetCompatHash_RSP_T GetRtcCompatHash1_RSP_T;
...
int Model_Target_HandleSchRequest(void* pReqBuf, uint32_t reqBufSize,
    void* pRspBuf, uint32_t rspBufSize);
int Model_Target_UseDispatchTable(void* pReqBuf, uint32_t reqBufSize,
    void* pRspBuf, uint32_t rspBufSize,
    Model_Target_RTC_REQ_RSP_type* table, uint32_t tableElements);

#endif                                 /* RTW_HEADER_Model_Target_SCH_API_h_ */
