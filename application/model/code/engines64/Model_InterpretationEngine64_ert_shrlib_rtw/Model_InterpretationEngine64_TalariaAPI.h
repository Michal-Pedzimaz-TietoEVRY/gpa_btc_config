/*
 * File: Model_InterpretationEngine64_TalariaAPI.h
 *
...
#ifndef RTW_HEADER_Model_InterpretationEngine64_TalariaAPI_h_
#define RTW_HEADER_Model_InterpretationEngine64_TalariaAPI_h_
#include <stdint.h>

// ------------------------------------------------------------
// MODEL SYNCHRONOUS PROCESSING INTERFACE
// ------------------------------------------------------------
#define MODEL_FUNC(fname)              Model_InterpretationEngine64_ ## fname
#define MODEL_HEADER_FILENAME          "Model_InterpretationEngine64.h"
...
// (Officially declared in Model_InterpretationEngine64.h)
...
// ------------------------------------------------------------
int Model_InterpretationEngine64_ServiceNotifications(void* pNtfBuf, uint32_t
    nftBufSize);

// ------------------------------------------------------------
// ASDID ASYNCHRONOUS MESSAGE HANDLER
// ------------------------------------------------------------
int Model_InterpretationEngine64_HandleAsdIdRequest(void* pReqBuf, uint32_t
    reqBufSize,
    void* pRspBuf, uint32_t rspBufSize);

#endif               /* RTW_HEADER_Model_InterpretationEngine64_TalariaAPI_h_ */
