% Autogenerated file: Wed Mar  6 16:16:13 2024
...
wr = coder.internal.writeDataInterfacesToCodeDescriptor("Model_InterpretationEngine64",pwd) ;
...
skippedParameters = [];
    ...
    func_Initialize_Prototype.Return     = tmpRet;
        ...
        func_Initialize_Prototype.HeaderFile = 'Model_InterpretationEngine64.h';
    func_Initialize_Prototype.SourceFile = 'Model_InterpretationEngine64.c';
    ...
    func_Initialize_Interface.ActualReturn = tmpActualReturn;
        ...
        func_Initialize_Prototype.Name = 'Model_InterpretationEngine64_initialize';
    ...
    func_OutputUpdate_Prototype.Return     = tmpRet;
        ...
        func_OutputUpdate_Prototype.HeaderFile = 'Model_InterpretationEngine64.h';
    func_OutputUpdate_Prototype.SourceFile = 'Model_InterpretationEngine64.c';
    ...
    func_OutputUpdate_Interface.ActualReturn = tmpActualReturn;
            ...
            func_OutputUpdate_Prototype.Name = 'Model_InterpretationEngine64_step';
    ...
    func_Terminate_Prototype.Return     = tmpRet;
        ...
        func_Terminate_Prototype.HeaderFile = 'Model_InterpretationEngine64.h';
    func_Terminate_Prototype.SourceFile = 'Model_InterpretationEngine64.c';
    ...
    time_constant = codeInfo.TimingProperties(getIndexFromTimingInternalId(codeInfo.TimingInternalIds, -1));
        func_Terminate_Interface.Timing = time_constant;
                func_Terminate_Prototype.Name = ['Model_InterpretationEngine64_terminate'];
        codeInfo.TerminateFunctions =  [codeInfo.TerminateFunctions, func_Terminate_Interface'];
            ...
            type_RTModel.Identifier = 'RT_MODEL_Model_InterpretationEngine64_T';
        ...
        Var_RTModel = RTW.Variable(Ptrtype_RTModel_1_0.BaseType, 'Model_InterpretationEngine64_M_');
        Var_RTModel.Owner           = 'Model_InterpretationEngine64';
        Var_RTModel.DeclarationFile = 'Model_InterpretationEngine64.h';
            Var_RTModel.DefinitionFile  = 'Model_InterpretationEngine64.c';
        

        % Pointer Variable: PtrVar_RTModel
        PtrVar_RTModel = RTW.PointerVariable(Ptrtype_RTModel_1_0, 'Model_InterpretationEngine64_M', Var_RTModel);
        ...
        idata_RTModel = RTW.DataInterface('', 'RTModel', PtrVar_RTModel, empty_timing);
            ...
            wr.removeEmptyFunctionFromSubsystemInterface('52', 'Model_InterpretationEngine64_PostProcess_Init');
            wr.removeEmptyFunctionFromSubsystemInterface('52', 'Model_InterpretationEngine64_PostProcess');
        ...
        wr.writeSubsystemFileInformation('52', 'PostProcess.h', 'PostProcess.c');
            ...
            wr.removeEmptyFunctionFromSubsystemInterface('141:244', 'Model_InterpretationEngine64_Medusa5H1Part1_Init');
            wr.removeEmptyFunctionFromSubsystemInterface('141:244', 'Model_InterpretationEngine64_Medusa5H1Part1');
        ...
        wr.writeSubsystemFileInformation('141:244', 'Model_InterpretationEngine64_private.h', 'Model_InterpretationEngine64.c');
            ...
            wr.removeEmptyFunctionFromSubsystemInterface('141:256', 'Model_InterpretationEngine64_Medusa5H1Part2_Init');
            wr.removeEmptyFunctionFromSubsystemInterface('141:256', 'Model_InterpretationEngine64_Medusa5H1Part2');
        ...
        wr.writeSubsystemFileInformation('141:256', 'Model_InterpretationEngine64_private.h', 'Model_InterpretationEngine64.c');
