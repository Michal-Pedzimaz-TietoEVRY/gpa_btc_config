/*
 * File: Model_TranslationEngine64_TuneVar.h
 *
...
#ifndef RTW_HEADER_Model_TranslationEngine64_TuneVar_h_
#define RTW_HEADER_Model_TranslationEngine64_TuneVar_h_
#include "Model_TranslationEngine64_TranslateTrigger.h" // for TranslateEngineIterator
#ifdef INCLUDE_TRANSLATION_DLL_API

// Returns a tune variable record if name is recognized, -1 otherwise
...
extern void* Model_TranslationEngine64_tune_var_table;
extern int Model_TranslationEngine64_tune_var_table_count;

#endif                     /* RTW_HEADER_Model_TranslationEngine64_TuneVar_h_ */
